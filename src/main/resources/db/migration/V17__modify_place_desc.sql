...
CREATE TABLE icon
(
    icon_id BIGINT AUTO_INCREMENT NOT NULL,
...
ALTER TABLE place_description
    ADD icon_id BIGINT NULL;

ALTER TABLE place_description
    ADD CONSTRAINT FK_PLACEDESCRIPTION_ON_ICON FOREIGN KEY (icon_id) REFERENCES icon (icon_id);
...
-- icon 테이블에 아이콘 데이터 삽입
INSERT INTO icon (name, url)
VALUES ('운영시기', 'https://d35m5peyvblzpd.cloudfront.net/icons/period.svg'),
       ('운영시간', 'https://d35m5peyvblzpd.cloudfront.net/icons/time.svg'),
       ('포함사항', 'https://d35m5peyvblzpd.cloudfront.net/icons/checklist.svg'),
       ('이용요금', 'https://d35m5peyvblzpd.cloudfront.net/icons/charge.svg'),
       ('이용가능 연령', 'https://d35m5peyvblzpd.cloudfront.net/icons/age.svg'),
       ('체험 준비물', 'https://d35m5peyvblzpd.cloudfront.net/icons/bag.svg'),
       ('주차가능', 'https://d35m5peyvblzpd.cloudfront.net/icons/parking.svg'),
       ('샤워시설', 'https://d35m5peyvblzpd.cloudfront.net/icons/shower.svg'),
       ('인스타그램', 'https://d35m5peyvblzpd.cloudfront.net/icons/insta.svg'),
       ('카카오채널', 'https://d35m5peyvblzpd.cloudfront.net/icons/kakao-channel.svg');
